...
class collectedMondeeModel: ObservableObject {
    @Published var collectedMondees: [CollectedMondee] = [
        ...
        CollectedMondee(index: 2, collectedMondeeName: "사탕먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee002-IOS", isCollected: true),
        CollectedMondee(index: 3, collectedMondeeName: "선디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgMondeeLevel1-IOS", isCollected: false),
        CollectedMondee(index: 4, collectedMondeeName: "오너먼트먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee003-IOS", isCollected: true),
        CollectedMondee(index: 5, collectedMondeeName: "화분먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee005-IOS", isCollected: false),
        ...
        CollectedMondee(index: 21, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 22, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 23, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 24, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 25, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 26, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 27, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 28, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 29, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 30, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true),
        CollectedMondee(index: 31, collectedMondeeName: "실버먼디", collectedMondeeDate: Date(), collectedMondeeDescription: "푸딩 먼디는 냉장고 속 검은봉투에 있었어요.\n청소한 덕분에 깨끗한 녹색을 되찾았답니다!", collectedMondeeImg: "ImgCollectedMondee006-IOS", isCollected: true)
    ]
}
